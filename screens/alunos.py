...
class AlunosScreen:
    ...
    def create_widgets(self):
        ...
        tk.Label(header, text="Gerenciamento de Alunos", 
        ...
        self.tree = ttk.Treeview(tree_frame, columns=('ID', 'Nome', 'CPF', 'Data Nasc', 'Turma'),
        ...
        self.tree.column('Data Nasc', width=120)
    ...
    def carregar_dados(self):
        ...
        try:
            ...
            for aluno in alunos:
                turma_nome = ""
                if aluno.turma_id:
                    turma = session.query(Turma).filter_by(id=aluno.turma_id).first()
                    if turma:
